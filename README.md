...
<table>
  ...
  <tr>
    ...
    <td align="center">bank_loan_data_insights.pbix</td>
    <td align="center">bank_loan_data_viz.twbx</td>
  </tr>
  <tr>
...
1. **Clone the Repository**:
    ...
    ```
2. **Database Setup**:
    - Use the provided SQL script (`sql/loan_queries.sql`) to set up the database in SQL Management Server.
    - Import the loan dataset into the created database.

3. **Excel Setup**:
    - Open the provided Excel file (`excel/loan_data_analysis.xlsx`) to review preliminary analyses and data processing steps.

4. **Power BI Setup**:
    - Open the provided Power BI file (`powerBI/bank_loan_data_insights.pbix`).
    - Connect the BI file to your SQL Server database.

5. **Tableau Setup**:
    - Open the provided Tableau workbook (`tableau/bank_loan_data_viz.twbx`).
